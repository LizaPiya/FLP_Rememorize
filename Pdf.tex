...
All models evaluated on n=100 (MIMIC extended test set) for MIMIC; n=20 for SOAP.
...
Contextual and AgenticSum results to be added.}
...
Mistral-7B                            & 13.36 & \textbf{55.27} & 52.75 & \textbf{9.49} & 18.22 & 49.89 & 62.57 & 11.30 \\
Flan-T5 XXL                           & 10.58 & 53.13 & 37.68 & 16.98 & --    & --    & --    & --    \\
MedAlpaca-7B                          & \textbf{13.70} & 56.87 & 53.89 & 18.00 & --    & --    & --    & --    \\
Contextual                            & --    & --    & --    & --    & --    & --    & --    & --    \\
AgenticSum                            & --    & --    & --    & --    & --    & --    & --    & --    \\
\midrule
...
\begin{table*}[t]
\centering
\caption{LLM-as-a-Judge evaluation (Qwen2.5-7B-Instruct, 0\% parse failure rate). All scores on a 1--5 scale. Higher is better except Hallucination ($\downarrow$).}
\label{tab:llm_judge}
...
\midrule
Llama-3.2-3B-Instruct      & 2.05 & 3.45          & 3.23          & 3.62          & 1.30          & \textbf{4.25} & \textbf{3.55} & \textbf{4.70} \\
Mistral-7B                 & 2.15 & \textbf{3.60} & \textbf{3.33} & \textbf{3.88} & \textbf{1.20} & 3.95          & 3.40          & 4.15          \\
\midrule
\textbf{ReMemorize (Ours)} & \textbf{1.68} & 3.52 & 3.15 & 3.83                  & \textbf{1.20} & 2.90          & 2.40          & 3.35          \\
\bottomrule
\end{tabular}
\end{table*}
