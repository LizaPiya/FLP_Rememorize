...
\begin{table*}[t]
\centering
\caption{Summary generation performance on MIMIC-IV-Ext-BHC and SOAP datasets (n=20 each).
Higher is better for R-L, BS-F1, and Factuality ($\uparrow$); lower is better for Hallucination ($\downarrow$).
Factuality and Hallucination scored via DeBERTa-v3 NLI entailment/contradiction probability.
Remaining baselines and LLM judge scores to be added.}
...
AgenticSum                            & --    & --    & --    & --    & --    & --    & --    & --    \\
\midrule
\textbf{ReMemorize (Ours)}            & \textbf{13.39} & 54.48 & 44.06 & 21.96 & 13.62 & 50.41 & \textbf{76.24} & \textbf{5.91} \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table}[t]
\centering
\caption{Ablations on MIMIC-IV (n=20). All values in \%. Bold = best per metric. NLI Fact./Hall.\ = DeBERTa-v3 entailment/contradiction. Judge = Qwen2.5-7B-Instruct scores.}
...
w/o RL                            & 22.19 & 4.94 & 12.05 & 10.56 & 4.58 & 53.74 & 60.34 & 18.36 & --   & --   & --   \\
w/o Hall.\ Penalty                & --    & --   & --    & --    & --   & --    & --    & --    & --   & --   & --   \\
w/o Aux.\ Loss                    & --    & --   & --    & --    & --   & --    & --    & --    & --   & --   & --   \\
\bottomrule
\end{tabular}
